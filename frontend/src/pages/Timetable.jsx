...
import { getEvents, createEvent, updateEvent, deleteEvent, setTheme as apiSetTheme, getCategories, createCategory, deleteCategory, getPresets } from '../api';
...
export default function Timetable() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      setEvents(evs); setCategories(cats); setPresets(prs);
